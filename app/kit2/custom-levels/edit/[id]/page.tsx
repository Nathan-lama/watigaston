...
export default function EditKit2CustomLevel() {
  const { id } = useParams();
          ...
          <div className="flex flex-col md:flex-row gap-8">
            ...
            <div className="md:w-1/3">
              ...
              <div className="mt-6 border-t pt-4">
                <h3 className="text-lg font-medium text-gray-800 mb-3">Éléments à placer sur le plateau</h3>
                  ...
                  {Object.values(puzzlePieces)
                    ...
                    .map((piece) => (
                      <div key={piece.type} className="text-center">
                        ...
                        />
                        <p className="text-xs mt-1">{piece.name}</p>
                      </div>
                    ))}
                </div>
